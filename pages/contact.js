  ...
  return (
    <>
      ...
      <p className="my-2 tracking-normal leading-normal text-xl dark:text-gray-400">
        No really. I <i>love</i> talking with anyone in the dev tools space.
      ...
      <div className="relative pb-20">
        ...
        >
          <source
            src="/videos/clip-fast-square-compressed.mp4"
            type="video/mp4"
          />
        </video>
        <ul
          className="absolute lg:top-20 top-0 flex flex-row flex-wrap left-0 w-full"
          style={{ marginTop: '50%' }}
        >
          {services.map((s, idx) => (
            <li>
              <a
                className="text-display p-5 m-2 lg:mix-blend-multiply lg:bg-gray-700 bg-gray-900 block hover:mix-blend-normal hover:bg-gray-900"
                href={s.url}
                target="_blank"
                rel="noopener"
              >
