    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Kathy Korevec: Head of Product at Vercel"
        />
        <meta
          property="og:image"
          content="https://kathy.pm/images/avatar-compressed.webp"
        />
        <script
      ...
      <div className="page-container dark:bg-gray-800">
        ...
        <div className="antialiased flex flex-col items-center justify-center min-h-screen py-2 px-4 max-w-3xl pb-16 mx-auto">
          <header className="flex lg:mt-12 mt-6 lg:mb-16 mb-6 justify-between w-full items-center">
            <Link href="/">
              ...
              >
                ...
                <polygon
                  fill="url(#g1)"
                  points="160.17 0 0 277.42 320.34 277.42 160.17 0"
                />
                <path
                  fill="white"
                  className="cls-1"
                  d="M180,234.14l-31.19-42.82L137.2,203.39v30.75H115.07V133.56H137.2v44l40.8-44h26.73l-40.95,42.67,42.82,57.91Z"
            ...
            <nav className="flex justify-right gap-12 text-center text-s border-2 border-purple-600 dark:border-purple-400 rounded-full text-purple-600 hover:text-white hover:bg-purple-600 font-bold uppercase tracking-wide fancy-border hover:fancy-background dark:text-purple-400 dark:hover:text-gray-900 dark:hover:bg-purple-400">
              <Link href="/contact" className="no-underline">
                <span className="p-2 px-4 block cursor-pointer">
                  Say Hi <span className="hand-wave inline-block">👋</span>
                </span>
              </Link>
            </nav>
          </header>
          ...
          <button
            className="dark-toggle-button rounded-full border-2 p-3 my-10"
            aria-label="Toggle Dark Mode"
            onClick={clickedDarkToggle}
          >
            <svg
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
