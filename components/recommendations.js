...
export default function Recommendations() {
  return (
    <div id="recs" className="pt-8 mt-8">
          ...
          {recommendations.map((rec) => (
            <li key={rec.full_name} className="flex my-16 mx-0">
              ...
              <div>
                ...
                <span className="block mb-6  dark:text-gray-400">
                  {rec.role}
                </span>
                <p className="mb-6 leading-6 text-gray-700 dark:text-gray-400 dark:bg-gray-800 bg-white">
                  {rec.body}
                </p>
